...
const fetchAirports = async () => {
    try {
        ...
        if (!response.ok) {
            throw new AirportFetchError('공항정보를 가져오지 못하였습니다.', response.status);
        }
        ...
        throw new AirportFetchError('공항 데이터 로딩 중 오류가 발생했습니다: ' + error.message);
    }
};
